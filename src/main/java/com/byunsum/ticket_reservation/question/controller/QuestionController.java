...
public class QuestionController {
    ...
    public ResponseEntity<QuestionResponseDto> createQuestion(
            @Valid @RequestBody QuestionRequestDto dto, @AuthenticationPrincipal Member member
    ) {
        if(member == null){
    ...
    public ResponseEntity<List<QuestionResponseDto>> getMyQuestions(@AuthenticationPrincipal Member member) {
        ...
        List<QuestionResponseDto> questions = questionService.findMyQuestions(member.getId());
